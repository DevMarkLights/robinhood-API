...
stockInfoMulti = Blueprint('getStockInfoMulti', __name__)

@stockInfoMulti.post('/ticker/stockInfoMulti')
def getStockInfoMulti():
    req = request.get_json()
    stocks = req['stocks'].split(",")
